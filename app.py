...
from ui import inject_google_css
...
### 🎮 Why this matters
&ranj is not just another e-learning provider — it designs **serious games that drive desired employee behaviors**.  
This app frames the **US go-to-market strategy** with that unique positioning at the center:
